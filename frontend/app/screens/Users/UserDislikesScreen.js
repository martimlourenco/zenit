...
export default function UserDislikesScreen() {
  const navigation = useNavigation();
  const route = useRoute();
  const { movies } = route.params; // "dislikes"
      ...
      <View style={styles.itemContainer}>
        ...
        <View style={styles.infoContainer}>
          ...
          >
            ...
            <Text style={styles.subtitle}>Dislike do utilizador</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
      ...
      >
        ...
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>Nenhum dislike.</Text>
          </View>
        </SafeAreaView>
      </KeyboardAvoidingView>
    );
