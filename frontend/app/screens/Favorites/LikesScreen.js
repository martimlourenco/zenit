...
export default function MyLikesScreen() {
  ...
  const fetchLikes = async () => {
    ...
    try {
      ...
      const response = await axios.get(`${API_BASE_URL}/likes/my-likes`, {
  ...
  const removeLike = async () => {
    ...
    try {
      ...
      await axios.post(
        `${API_BASE_URL}/likes`,
        { movieId: selectedMovie.tmdb_id, type: "like" },
        { headers: { Authorization: `Bearer ${token}` } }
      );
      fetchLikes();
    } catch (error) {
      ...
      <View style={styles.itemContainer}>
        ...
        <View style={styles.infoContainer}>
          <TouchableOpacity onPress={() => navigation.navigate('MovieDetails', { movieId: movie.tmdb_id })}>
            ...
            <Text style={styles.subtitle}>Tu deste Like</Text>
          </TouchableOpacity>
        </View>
    ...
    >
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.headerTitle}>Meus Likes</Text>
        </View>
        ...
        >
          <Pressable style={styles.menuOverlay} onPress={closeMenu}>
            <View style={styles.menuContainer}>
              ...
              <TouchableOpacity style={styles.menuOption} onPress={removeLike}>
                <Text style={[styles.menuOptionText, styles.menuOptionDanger]}>Remover Like</Text>
              </TouchableOpacity>
            </View>
          </Pressable>
        </Modal>
